 ...
 */
export interface TwitchSearchChannelResult {
    data: TwitchChannel[]
 ...
 */
export interface TwitchSearchClipResult {
    data: TwitchClip[]
    pagination: Pagination
}
 ...
 */
export interface TwitchSearchCategoryResult {
    data: TwitchCategory[]
    pagination: Pagination
}
 ...
 */
export interface TwitchSearchVideoResult {
    data: TwitchVideo[]
    pagination: Pagination
}
